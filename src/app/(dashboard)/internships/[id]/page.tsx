  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <Link
            href={session.user.role === "ADMIN" ? "/admin/internships" : session.user.role === "TEACHER" ? "/teacher/internships" : "/student/internship"}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <aside className="space-y-4">
          ...
          <div className="bg-white border border-gray-200 rounded-md p-5 shadow-sm">
            ...
            <div className="space-y-3">
              <Link href="/student/documents" className="block rounded-md border border-gray-200 bg-white px-4 py-3 text-[13px] font-medium text-gray-700 hover:bg-gray-50">
                View documents
              </Link>
              <Link href="/student/messages" className="block rounded-md border border-gray-200 bg-white px-4 py-3 text-[13px] font-medium text-gray-700 hover:bg-gray-50">
                Open messages
              </Link>
            </div>
          </div>
