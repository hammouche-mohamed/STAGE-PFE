    ...
    <div className="h-[calc(100vh-140px)] flex flex-col space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[13px] text-gray-500 mt-0.5">Stay in touch with your supervised students and company partners.</p>
        </div>
      </div>
      ...
      <div className="flex-1 bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
           {messages.map((msg) => {
             const isMe = msg.senderId === "current-user" || msg.senderId === "teacher-1";
             return (
