  ...
  return (
    <div className="-mt-4 md:-mt-6 h-[calc(100vh-115px)] flex flex-col space-y-3 overflow-hidden">
      <div className="flex-shrink-0">
        <h1 className="text-[17px] font-bold text-gray-900 leading-none">Oversight & Messages</h1>
        ...
        `}>
          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
              ...
              <p className="p-6 text-center text-[12px] text-gray-400 italic">No active internships</p>
            ) : (
              internships.map((i) => (
                <button
                  key={i.id}
