        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2 md:gap-3 overflow-hidden min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-[9px] md:text-[10px] text-gray-500 uppercase tracking-wider font-semibold mt-0.5 truncate">PFE Management Portal</span>
            </div>
          </div>
          ...
          <div className="lg:hidden flex-shrink-0">
            <Link
              href="/login"
              className="px-3 py-1.5 bg-indigo-600 text-white text-[11px] md:text-[12px] font-semibold rounded-md hover:bg-indigo-700 transition-all shadow-sm whitespace-nowrap"
            >
              Sign In
            </Link>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-16 md:mb-24">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full border border-indigo-100 mb-6">
              ...
              <span className="text-[11px] md:text-[12px] font-bold uppercase tracking-wider">Academic Year {academicYear}</span>
            </div>
